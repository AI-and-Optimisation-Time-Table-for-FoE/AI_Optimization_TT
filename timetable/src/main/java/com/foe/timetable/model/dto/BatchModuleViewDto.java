...
public class BatchModuleViewDto {
    ...
    private java.util.List<Integer> lecturerIds;
    ...
    public java.util.List<Integer> getLecturerIds() { return lecturerIds; }
    public void setLecturerIds(java.util.List<Integer> lecturerIds) { this.lecturerIds = lecturerIds; }
